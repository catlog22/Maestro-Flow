...
export function FloatingToc({ content }: FloatingTocProps) {
  ...
  return (
    <aside className="hidden xl:block w-[220px] shrink-0">
      <nav
        className="sticky top-[calc(var(--size-topbar-height)+var(--spacing-6))] max-h-[calc(100vh-var(--size-topbar-height)-var(--spacing-12))] overflow-y-auto bg-bg-card border border-border rounded-[var(--radius-lg)] p-[var(--spacing-4)] shadow-[var(--shadow-sm)]"
