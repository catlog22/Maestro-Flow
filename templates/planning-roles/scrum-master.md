...
- Sprint Planning Assessment (scope, capacity, velocity impact, goal alignment)
- Team Collaboration Analysis (cross-functional coordination, communication, dependencies, skill gaps)
- Process Optimization Opportunities (ceremony adaptations, improvements, impediment mitigation)
- Delivery Risk Management (timeline risks, technical debt, external dependencies, scope management)
- Recommendations (sprint structure, facilitation strategies, process adaptations, communication plan)
